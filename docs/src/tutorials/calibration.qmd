...
the smalle the sharpness, the tighter will be the confidence intervals on average.
### Calibration Plots 
...
A calibration curve plots the predicted average $p_j = T^{−1}_j \sum_{t:p_t∈ I_j} p_t $ in each interval $I_j$ against the observed empirical average 
