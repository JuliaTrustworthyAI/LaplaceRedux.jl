...
function Plots.plot(
    ...
    if la.likelihood == :regression
        ...
        plot!(x_range, fμ, color=2, label="yhat", ribbon = (1.96*pred_std, 1.96*pred_std), lw=lw; kwargs...)   # the specific values 1.96 are used here to create a 95% confidence interval
