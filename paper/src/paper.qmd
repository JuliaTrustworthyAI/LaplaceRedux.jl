...
\begin{lstlisting}[language=Julia, escapechar=@, numbers=left, label={lst:fit}, caption={}]
la = Laplace(nn; likelihood=:classification)
fit!(la, data)
\end{lstlisting}
...
\begin{lstlisting}[language=Julia, escapechar=@, numbers=left, label={lst:predict}, caption={}]
...
\begin{lstlisting}[language=Julia, escapechar=@, numbers=left, label={lst:other}, caption={}]
