...
demonstrated by \cite{immer2020improving}. Formally, we locally
...
\cite{immer2020improving} provide a much more detailed exposition of the
above with a focus on theoretical underpinnings and intuition.
...
package \texttt{LaplaceRedux.jl} offers a solid starting ground for a
